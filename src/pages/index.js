...
const contactFormDetails = [
  {
    title: "Get started",
    description: "Feel free to contact us. We're excited to know more about your business.",
  },
];
    ...
    <>
          ...
          <main className="grid gap-6 lg:gap-12 grid-cols-1 lg:grid-cols-2 mt-10 mx-auto w-full px-4 lg:px-0">
            <div className="m-auto text-left order-last lg:order-first">
              <h1 className="text-3xl md:text-4xl lg:text-5xl tracking-tight font-bold text-gray-800 leading-10 lg:leading-12">
                Boost your social media visibility now
              </h1>
              <p className="mt-3 text-base font-body text-gray-500 sm:mt-5 sm:text-lg w-full lg:max-w-xl mx-auto md:mt-5 md:text-xl lg:mx-0">
                Reach the maximum audience by creating and implementing our proven social media strategies.
              </p>
            ...
            <div className="relative z-0 text-right ">
              <Image className="w-auto relative rounded-3xl" src="/images/medical.jpg" width={600} height={400} quality={100} priority={true} />
            </div>
          </main>
        </div>
      </div>
      ...
      <div className="py-12 lg:py-20  bg-brandColor bg-opacity-5">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-semibold text-center text-gray-800 underline">Statistics</h1>
      ...
      <div className="py-12 lg:py-20 bg-white ">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-semibold text-center pb-10">Specialities at Navkar Hospital, Malegaon</h1>
      ...
      <div className="py-12 lg:py-20 xs:px-5  bg-brandColor bg-opacity-5">
        <div className="max-w-7xl mx-auto">
          <div className="lg:flex justify-between items-center">
            <h1 className="text-2xl text-gray-900 font-medium">Navkar hospitals is a not-for-profit organization.</h1>
      ...
      <div className="py-12 lg:py-20  bg-brandColor bg-opacity-5">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl text-gray-900 font-medium xs:text-center underline">Awards and Accreditations</h1>
          <p className="text-gray-900 pt-5 text-base xs:mx-5">
            Committed to providing compassionate, quality care with a patient-centric approach at an affordable cost, Navkar Hospital in Malegaon, Malegaon has
            been awarded and accredited by several national and international organisations:
          </p>
          <div className="grid grid-cols-12  text-gray-800 mt-5 text-sm gap-5 mx-5">
            <div className="lg:col-span-6 col-span-12">
              <div className="flex items-center justify-start gap-2">
                ...
                <p>National Energy Conservation Award – bestowed by the honourable President of India</p>
              </div>
            </div>
            <div className="lg:col-span-6 col-span-12">
              <div className="flex items-center justify-start gap-2">
                <CheckCircleIcon className="w-5 h-5 text-rose-500  rounded-full inline-block" />
                <p>NABH (National Accreditation Board of Hospitals) 1st hospital in Malegaon to be accredited</p>
              </div>
            </div>
            <div className="lg:col-span-6 col-span-12">
              <div className="flex items-center justify-start gap-2">
                ...
                <p>
                  ...
                  NABL Only hospital in Malegaon with an SRL-NABL accredited pathology laboratory
                </p>
              </div>
            </div>
            <div className="lg:col-span-6 col-span-12">
              <div className="flex items-center justify-start gap-2">
                ...
                <p>NABH Nursing 1st hospital in Malegaon to be accredited for excellence in nursing.</p>
              </div>
            </div>
          </div>
        </div>
